...
def main(args, config):
    ...
    train_loader, test_loader = create_loader(datasets,samplers,batch_size=[config['batch_size_train'],config['batch_size_train']],
                                              num_workers=[0,0],is_trains=[True, False], collate_fns=[collate_fn,collate_fn_val])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='./checkpoints/mplug_large.pth')
    parser.add_argument('--eval_checkpoint', default='./output/output/checkpoint_best.pth')
    ...
    parser.add_argument('--dataset', default='vg_unc')
    ...
    parser.add_argument('--do_two_optim', default=True, action='store_true')
